...
impl ConnectionState {
    pub fn to_backlist_key(self: &Self) -> Session {
        Session {
...
impl Connection {
    ...
    #[inline(always)]
    pub fn into_session(self: &Self) -> Session {
        Session {
            src_ip: self.dst_ip,
    ...
    #[inline(always)]
    pub fn into_state(self: &Self) -> ConnectionState {
        ConnectionState {
            last_syn_ack_time: 0,
            syn_ack_count: 0,
    ...
    #[inline(always)]
    pub fn into_state_listen(self: &Self) -> ConnectionState {
        ConnectionState {
            last_syn_ack_time: 0,
            syn_ack_count: 0,
            remote_ip: self.dst_ip,
